...
async def send_verification_email(email: str, user_id: int, activation_token: str = None) -> bool:
    ...
    activation_url = f"https://yourapp.com/activate?user_id={user_id}&token={activation_token or 'placeholder_token'}"
...
async def send_password_reset_email(email: str, user_id: int, reset_token: str = None) -> bool:
    ...
    reset_url = f"https://yourapp.com/reset-password?user_id={user_id}&token={reset_token or 'placeholder_token'}"
